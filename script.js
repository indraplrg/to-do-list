...
function createList(text, status = false) {
  ...
  let li = `<li class='list-style ${ifDone}'><span onclick='done(this)'>${text}</span><span class='delButton' onclick="remove(this)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
